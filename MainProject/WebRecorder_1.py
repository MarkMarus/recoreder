...
class WebRecorder:
    ...
    def run_localhost(self, number):
        self.console = subprocess.Popen(f'ffmpeg -f avfoundation -vcodec libx254 -r 60 -i "1" video{number}.mp4', stdout=subprocess.PIPE, shell=True)
    ...
    def first_page(self):
        ...
        """)
        time.sleep(15)
        self.console.send_signal(signal.CTRL_C_EVENT)
        subprocess.call('ffmpeg -i video1.mp4 -vf "crop=646:1400:562:355" -c:v libx264 -crf 17 -c:a copy result1.mp4', shell=True)
    ...
    def third_page(self):
        ...
        time.sleep(15)
        self.console.send_signal(signal.CTRL_C_EVENT)
        subprocess.call('ffmpeg -i video3.mp4 -vf "crop=646:1400:562:355" -c:v libx264 -crf 17 -c:a copy result3.mp4', shell= True)
    ...
    def second_page(self):
        ...
        time.sleep(15)
        self.console.send_signal(signal.CTRL_C_EVENT)
        subprocess.call('ffmpeg -i video2.mp4 -vf "crop=646:1400:562:355" -c:v libx264 -crf 17 -c:a copy result2.mp4', shell=True)
    ...
    def image(self):
        with Image.open('noback.png') as img:
                    ...
                    font = ImageFont.truetype('HTML/SF-Pro-Display-Semibold.ttf', 24)
                    I1.text((55, 26), strftime("%H:%M"), font=font, fill=(255, 255, 255))
